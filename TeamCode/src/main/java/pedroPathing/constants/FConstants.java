...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 17.24;

        FollowerConstants.xMovement = 57.74681099627573;
        FollowerConstants.yMovement = 42.851472064001406;

        FollowerConstants.forwardZeroPowerAcceleration = -34.27808569168583;
        FollowerConstants.lateralZeroPowerAcceleration = -78.07189160806999;
